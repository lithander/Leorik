...
fn main() {
    let mut trainer = TrainerBuilder::default()
        ...
        .input(inputs::ChessBucketsMirrored::new(INPUT_BUCKETS))
    ...
    let schedule = TrainingSchedule {
		...
		// This controls the mix of WDL/Eval used, 1.0 = all WDL
        wdl_scheduler: wdl::ConstantWDL { value: 1.0 },
		// Learning rate schedule, this means it starts at 0.001,
		// and every 15 epochs you multiply it by 0.3
        lr_scheduler: lr::StepLR { start: 0.001, gamma: 0.75, step: 50 },
        save_rate: 40,
    };
